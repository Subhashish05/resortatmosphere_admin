...
export default function LoginPage() {
    ...
    const togglePasswordVisibility = () => {
        ...
        if (input) {
            ...
            // Use setTimeout to wait for the DOM re-render of the input type
            setTimeout(() => {
                input.focus();
                // Sets cursor position to the very end
    ...
    return (
        <div className="login_container p-4 h-screen w-full">
            <div className="bg-mid pb-8 px-8 rounded-sm shadow w-full max-w-md">
                <Image src="/img/logo.png" alt="Logo" width={160} height={160} className="mx-auto" />
                <form onSubmit={handleLogin} className="space-y-4">
                    ...
                    <div className="relative mb-4">
                        ...
                        <button
                            type="button"
                            onClick={togglePasswordVisibility} // Reference the new function
